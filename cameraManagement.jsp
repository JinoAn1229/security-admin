		...
		var j_sLastSearchParam = ""; // 마지막 조회 조건문 
       	...
       	// 목록 갱신
    		...
    		// 화일 저장을 위해 마지작 조회 조건문 저장
       		...
       		var strQuery = "./query/query_cameraManagement_list.jsp?" + sPageParam + "&" + sSearchParam;
...
//     	            	  + "<td>" + jM.ccdate + "</td>"
     	            	  + "<td>" + jM.cmid + "</td>"
//     	            	  + "<td>" + jM.cuid + "</td>"
       	                  + "<td><a href=\"javascript:FnDelCamera('" +  jM.cuid + "')\" class='shape-btn'>" + '<%=p_bundle.getString("table_btn_camera_del")%>' + "</a></td>"
       				  + "</tr>";
       	...
       	{
//       		location.href='./proc/down_cameraManagement_list.jsp?' + j_sLastSearchParam;
       	}
     	...
     	//  	     cuid   :   sval 파라메터로 CCTV 판매ID가 전달된다.
		...
		//============================ 	
       	// 카메라 삭제 버튼 클릭
      	// cuid  = CAMERA_UID
      	function FnDelCamera(cuid)
       	{
			if (confirm("정말 삭제하시겠습니까???") == true)
			{
				var sURL = './query/query_camera_detach.jsp?cid=' + cuid;
    ...
    <body>
        ...
        <div id="wrapper">
            ...
            <div class="content-wrap">
                ...
                <div id="contents">
                    <div class="container">
                        <h3 class="tit-list"><%=p_bundle.getString("cameraManagement_title")%></h3>
                      ...
                      <div class="search-wrap">
                                ...
                                <li>
                                    ...
                                    <div class="dist-cont">
                                        <select name=""  id="id_search_type">
                                            ...
                                            <option value="cmid"><%=p_bundle.getString("search_menu_cameraID")%></option>
                                        </select>
                                ...
                                <li class="period">
                                    ...
                                    <div class="dist-cont">
                                        ...
                                        <p>
                                            ...
                                            <button id='id_set_search_date_60' class="btn-option"  onClick='FnSetSearchDate(60);'><%=p_bundle.getString("search_date_60day")%></button>
                                            <button id='id_set_search_date_90' class="btn-option"  onClick='FnSetSearchDate(90);'><%=p_bundle.getString("search_date_90day")%></button>
                                        </p>
                                        <p >
                            ...
                            <button class="btn-list btn-search blue"  onClick='FnSearchDeviceList()'><%=p_bundle.getString("search_btn_text")%></button>
                        </div>
                        <!-- // 조회영역 -->
...
<!--                                            <col style="width:15%">-->
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th><%=p_bundle.getString("table_header_camera_name")%></th>
<!--                                                <th>코드부여일</th>-->
                                                <th><%=p_bundle.getString("table_header_camera_ID")%></th>
<!--                                                <th>CCTV 제조ID </th>-->
                                                <th><%=p_bundle.getString("table_header_camera_del")%></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
