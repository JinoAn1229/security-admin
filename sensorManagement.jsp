		...
		var j_sLastSearchParam = ""; // 마지막 조회 조건문 
       	...
       	// 목록 갱신
    		...
    		// 화일 저장을 위해 마지작 조회 조건문 저장
       		...
       		var strQuery = "./query/query_sensorManagement_list.jsp?" + sPageParam + "&" + sSearchParam;
...
*/
       	    var tr_html = "<tr>"
       	            	  ...
       	            	  + "<td>" + jM.gid + "</td>"
     	            	  + "<td>" + jM.sname + "</td>"
       	                  + "<td><a href=\"javascript:FnDelSensor('" +  jM.sid + "')\" class='shape-btn'>" + '<%=p_bundle.getString("table_btn_sensor_del")%>' + "</a></td>"
       				  + "</tr>";
...
//       		location.href='./proc/down_deviceManagement_list.jsp?' + j_sLastSearchParam;
		...
		//============================ 	
      	function FnDelSensor(sid)
       	{
			if (confirm("정말 삭제하시겠습니까??") == true)
			{
			var sURL = './query/query_sensor_detach.jsp?ssid=' + sid;
    ...
    <body>
        <div id="wrapper">
            ...
            <div class="content-wrap">
                ...
                <div id="contents">
                    <div class="container">
                        <h3 class="tit-list"><%=p_bundle.getString("sensorManagement_title")%></h3>
                                    ...
                                    <div class="dist-cont">
                                        <select name=""  id="id_search_type">
                                            ...
                                            <option value="id"><%=p_bundle.getString("search_menu_ID")%></option>
                                   			<option value="sid"><%=p_bundle.getString("search_menu_semsorID")%></option>
                                            <option value="gid"><%=p_bundle.getString("search_menu_gateID")%></option>
                                        </select>
                                    ...
                                    <table summary="">
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th><%=p_bundle.getString("table_header_sensorID")%></th>
                                                <th><%=p_bundle.getString("table_header_gateID")%></th>
                                                <th><%=p_bundle.getString("table_header_sensor_name")%></th>
                                                <th><%=p_bundle.getString("table_header_sensor_del")%></th>
                                            </tr>
                                        </thead>
                                    </table>
                                </div>
