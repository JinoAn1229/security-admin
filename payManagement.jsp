       	...
       	// 목록 갱신
      		...
      		if(!bSearchValue && !bAndDate)
    		{
      		...
      		sSearchParam = 	sSearchValParam + sSearchDateParam;
       		...
       		var strQuery = "./query/query_payManagement_list.jsp?" + sPageParam + "&" + sSearchParam;
       	 ...
       	 {   // table 은 thead, tbody 구분되어 만들어져 있어야 함
       		 var nCount = $("#id_list_payment >tbody >tr").length;
       		 for(var i = 0; i < nCount ; i ++)
       		 {  
       			 $('#id_list_payment > tbody:last > tr:last').remove();
       		 }
...
/*
   <tr>
      ...
      <td>2016-07-01</td>
      <td>남</td>
      <td>경기도 부천시 XXX구 XXX로 888 (XXX동) XXX-XX </td>
      <td>2016-07-01</td>
      <td>INI5987896</td>
      <td>9,900</td>
  </tr>
*/
       		...
       		$('#id_list_payment > tbody:last').append(tr_html);
       	 }
       	 //=================================
       	//  페이지 리스트 Navi관련 
