...
<%@ page import="wguard.dao.DaoSensorCar" %>    
<%@ page import="wguard.dao.DaoSensorCar.DaoSensorCarRecord" %>  
...
DaoSensorCar  daoSS = new DaoSensorCar();
	...
	//else
		nTotalRecordCnt = (int)daoSS.getSensorCarCount();
	...
	ArrayList<DaoSensorCarRecord> tableSSR = daoSS.selectSensorCarForList(nFirstRecNo,nFirstRecNo+nListPerPage-1);

	strTableHtml = daoSS.getTableHtml(tableSSR,nFirstRecNo);
...
<body>
<div class="body_wrap" style="width: 600px;  margin: 0 auto;" >
	<div style="width: 100%; color: white; background-color: black; height=30px; ">주차관리</div>
	<div class="vCenter" style="width: 100%; color: white; background-color: #CCCCCC; height=110px;"></div>
	...
	<form  id="id_page_frm" action="SensorCarRecord.jsp">
